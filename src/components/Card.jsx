...
const Card = ({ product }) => {
  const { price, name, image, description, rat, id, afterPrice } = product;
    ...
    >
      ...
      <div className="mt-4 px-5 pb-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <div  onClick={() => addCart(product, id)} className="flex items-center rounded-md bg-black px-5 py-2.5 text-center text-xs font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300 cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
